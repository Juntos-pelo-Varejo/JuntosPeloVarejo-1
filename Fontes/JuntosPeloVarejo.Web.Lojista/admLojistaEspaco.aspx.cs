...
{
    public partial class admLojistaEspaco : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (i % 2 == 0)
                    lista.Add(new Vendedor() { ID = i, Nome = "Espaço " + i.ToString(), Ativo = true });
                else
                    lista.Add(new Vendedor() { ID = i, Nome = "Espaço " + i.ToString(), Ativo = false });
            }
