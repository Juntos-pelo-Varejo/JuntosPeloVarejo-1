<%@ Page Title="" Language="C#" MasterPageFile="~/mpLojista.Master" AutoEventWireup="true" CodeBehind="admLojistaVendedor.aspx.cs" Inherits="JuntosPeloVarejo.Web.Lojista.admLojistaVendedor" %>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Cadastro de Vendedor</li>
                    </ol>
                </div>
            </div>
        </div>
