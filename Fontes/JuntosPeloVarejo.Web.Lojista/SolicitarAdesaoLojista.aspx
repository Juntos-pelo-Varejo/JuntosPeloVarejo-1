<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitarAdesaoLojista.aspx.cs" Inherits="JuntosPeloVarejo.Web.Lojista.SolicitarAdesaoLojista" %>
...
<head runat="server">
    ...
    <title>.:: Juntos pelo varejo - Lojista - Adesão ::.</title>
        ...
        <div class="register-box">
            ...
            <div class="card">
                <div class="card-body register-card-body">
                    <p class="login-box-msg">Formulário de adesão - Lojista</p>
                        ...
                        <div class="col-6">
                            <div class="icheck-primary">
                                ...
                                <label for="agreeTerms">
                                    Aceito o <a href="#">termo</a>
                                </label>
                            </div>
                        </div>
                        <!-- /.col -->
                        <div class="col-6">
                            <button type="submit" class="btn btn-primary btn-block">Solicitar adesão</button>
                        </div>
                        <!-- /.col -->
                    </div>

                    <a href="login.aspx" class="text-center">Já estou unido a rede</a>
                </div>
                <!-- /.form-box -->
            </div>
            <!-- /.card -->
