<%@ Page Title="" Language="C#" MasterPageFile="~/mpLojista.Master" AutoEventWireup="true" CodeBehind="admLojistaProduto.aspx.cs" Inherits="JuntosPeloVarejo.Web.Lojista.admLojistaProduto" %>
                                        ...
                                        <asp:Repeater ID="rptLista" runat="server" OnItemCommand="rptLista_ItemCommand">
                                            ...
                                            <ItemTemplate>
                                                <tr style='<%#  Boolean.Parse( DataBinder.Eval(Container.DataItem, "Ativo").ToString()) ? "": "color:red;"  %>'>
                                                    <td style="width: 5%"><%#  DataBinder.Eval(Container.DataItem, "IDProduto")%></td>
                                                    <td style="width: 90%"><%#  DataBinder.Eval(Container.DataItem, "Nome")%></td>
                                                    <td class="btn-group btn-group-lg text-right" style="width: 5%">
                                                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Consultar" CommandArgument='<%#  DataBinder.Eval(Container.DataItem, "IDProduto")%>' ToolTip="Consultar"><i class="fas fa-edit"></i></asp:LinkButton>
                                                        |
                                            <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "IDProduto")%>' ToolTip="Excluir"><i class="fas fa-trash"></i> </asp:LinkButton>
                                                        |
                                            <asp:LinkButton ID="LinkButton12" runat="server" CommandName="Retornar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "IDProduto")%>' ToolTip="Retornar"><i class="fas fa-undo"></i>
                                            </asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
            ...
            <div class="col-md-6">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Resumo</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail3">
                            </div>
                        </div>
